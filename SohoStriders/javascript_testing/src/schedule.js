...
function costUp(costInitial, trainingCost){
	var cost = costInitial + trainingCost;  
	return cost;
};
function costDown(costInitial, trainingCost){
	if (trainingCost > costInitial) {
		alert("You have already deselected this session")
	} else {
	var cost = costInitial - trainingCost;
	return cost
	}
